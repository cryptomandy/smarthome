            ...
            <span class="calendar-prev" @click="prev">
                ...
                <g class="transform-group">
                    <g transform="scale(0.015625, 0.015625)">
                        <path d="M671.968 912c-12.288 0-24.576-4.672-33.952-14.048L286.048 545.984c-18.752-18.72-18.752-49.12 0-67.872l351.968-352c18.752-18.752 49.12-18.752 67.872 0 18.752 18.72 18.752 49.12 0 67.872l-318.016 318.048 318.016 318.016c18.752 18.752 18.752 49.12 0 67.872C696.544 907.328 684.256 912 671.968 912z" fill="#1137a0"></path>
                    </g>
                </g>
                </svg>
            </span>
...
export default {
    ...
    methods: {
        ...
        changeYear(){
            ...
            this.yearsShow=true
            this.years=[];
            for(let i=~~this.year-5;i<~~this.year+15;i++){
                this.years.push(i)
            }
        },
        selectYear(value){
